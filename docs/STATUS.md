...
Last updated: 2026-07-13 (GitHub issue #87 re-ran the mobile backend and checkout/orders smoke suites against the only available public backend candidate. The issue body and comments did not provide a new verified staging URL or safe Store A / Store B IDs, and the local public config target still returned Railway platform `404 Application not found` for probed backend routes).
