...
Current state: Completing that lineage, two operational requirements from the 2026-07-23 decision that had never been written into the runbook they apply to were added on 2026-07-28. Step 2 now states that the Cartaisy Expo organization requires hardware-key 2FA and scoped organization tokens for automation, and Step 3 gains an "Offboarding — Handing Back What Cartaisy Holds" subsection covering the Android upload keystore export, the bundle identifiers, what does not transfer because it was always merchant-owned, and revocation of Cartaisy's access to the merchant's Apple and Google Play accounts. The merchant-agreement half of offboarding is explicitly out of scope for the repo and remains an open business/legal task.
